...
function route($route, $function_to_call){
  ...
  $request_url = filter_var($_SERVER['REQUEST_URI'], FILTER_SANITIZE_URL);
   //? Here I need to change the location of the request URL for the subfolder (changed from original library)
   $request_url = substr($request_url, strpos($request_url, "april-12") + 1);   
   //?
